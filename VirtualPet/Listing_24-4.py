...
formclass, baseclass = uic.loadUiType("mainwindow.ui")  # 加载 ui 文件
...
class MyForm(baseclass, formclass):
    ...
    def __init__(self, parent=None):
        ...
        self.sleepImages = ["pic/sleep1.gif","pic/sleep2.gif","pic/sleep3.gif", "pic/sleep4.gif"]  # Here are the images
        self.eatImages = ["pic/eat1.gif", "pic/eat2.gif"]                                  # for the different animations
        ...
        self.myTimer1.start(500)  # Starts or restarts the timer with a timeout interval of msec milliseconds.
